	...
	/* ### FUNCTIONS ### */
		...
		function buildBadge() {
			...
			if(notEvaluated === 0) {
				...
				alert(`Il reste ${notEvaluated} critère(s) à évaluer avant de pouvoir générer un badge.`);
			}
		}
